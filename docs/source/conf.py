# -*- coding: utf-8 -*-
#
# sqlalchemy_upsert_kit documentation build configuration file, created by
...
import sqlalchemy_upsert_kit as package
...
# Add data for Jinja2
try:
    from sqlalchemy_upsert_kit.docs import doc_data
except:
    doc_data = dict()
